...
public class ReferencePositionDTO   {
  ...
  public ReferencePositionDTO heading(Integer heading) {
...
@Min(0) @Max(3600) 
  ...
  public ReferencePositionDTO speed(Integer speed) {
    this.speed = speed;
    return this;
  }
...
@Min(0) @Max(16383) 
  ...
  public ReferencePositionDTO latitude(Double latitude) {
...
@DecimalMin("-90.0") @DecimalMax("90.0") 
  ...
  public ReferencePositionDTO longitude(Double longitude) {
...
@DecimalMin("-180.0") @DecimalMax("180.0") 
  ...
  public ReferencePositionDTO altitude(Float altitude) {
...
@DecimalMin("-100000") @DecimalMax("800001") 
  ...
  public boolean equals(Object o) {
    ...
    ReferencePositionDTO referencePosition = (ReferencePositionDTO) o;
  ...
  public String toString() {
    ...
    sb.append("class ReferencePositionDTO {\n");
